            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                  ...
                  <span class="d-flex">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between" href="/admin/product-management?action=add">
                                <div class="d-flex align-items-center gap-3">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between" href="/admin/product-management">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                ...
                <li class="sidebar-item">
                  ...
                  <span class="d-flex">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        <li class="sidebar-item">
                            <a class="sidebar-link justify-content-between" href="/admin/order-management">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
